		...
		"m-auto max-h-[calc(100dvh-2rem)] w-[calc(100%-2rem)] flex-col overflow-hidden rounded-xl border p-0 shadow-2xl backdrop:bg-background/75 backdrop:backdrop-blur-sm",
		{
			...
			variants: {
				...
				variant: {
					...
					error: "border-error bg-error text-on-fill",
					info: "border-info bg-info text-on-fill",
					primary: "border-primary bg-primary text-on-fill",
					secondary: "border-secondary bg-secondary text-on-fill",
					success: "border-success bg-success text-on-fill",
					warning: "border-warning bg-warning text-on-fill",
				},
			},
		},
	);
